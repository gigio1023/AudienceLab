            ...
            server.middlewares.use("/simulation/__files.json", function (_req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 3]);
                            dir = path.resolve(fileURLToPath(new URL("./public/simulation", import.meta.url)));
                            return [4 /*yield*/, fs.readdir(dir)];
                        case 1:
                            entries = _b.sent();
                            files = entries.filter(function (entry) { return entry.endsWith(".jsonl"); });
                        ...
                        case 2:
                            ...
                            res.end(JSON.stringify({
                                ...
                                message: (_a = error_1 === null || error_1 === void 0 ? void 0 : error_1.message) !== null && _a !== void 0 ? _a : "unknown error"
                            }));
                            return [3 /*break*/, 3];
